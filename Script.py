...
ɪғ ʏᴏᴜ ᴄᴏʟʟᴇᴄᴛ 100 ᴘᴏɪɴᴛs, ʏᴏᴜ ᴡɪʟʟ ʙᴇ ɢɪᴠᴇɴ 1 ᴍᴏɴᴛʜ ᴘʀᴇᴍɪᴜᴍ.
============================
...
<u>ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪғɪᴇᴅ ᴛᴏᴅᴀʏ, ᴘʟᴇᴀꜱᴇ ᴄʟɪᴄᴋ ᴏɴ ᴠᴇʀɪғʏ & ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇꜱꜱ ғᴏʀ ᴛɪʟʟ ɴᴇxᴛ 24 ʜᴏᴜʀꜱ [1 ᴅᴀʏ]</u>
...
💢𝖭ᴏᴛᴇ :- 𝖠ʟʟ ᴍᴇ𝗌𝗌ᴀɢᴇ𝗌 ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏ-ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ 5 ᴍɪɴᴜᴛᴇ𝗌 ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ɪ𝗌𝗌ᴜᴇ𝗌.</i>"""
...
★ Mᴇssᴀɢᴇ <code>{}</code>"""
    ...
    CAPTION = """
<b>📂 Fɪʟᴇ ɴᴀᴍᴇ : <b>{file_name} By @Kanus_Network</b>"""
...
🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href=https://t.me/Kanus_Network>Kᴀɴᴜs Nᴇᴛᴡᴏʀᴋ</a>"""

    USERS_TXT = """
👇 ᴄᴏᴍᴍᴀɴᴅꜱ ʟɪꜱᴛ ғᴏʀ ᴜꜱᴇʀꜱ 👇
    
<blockquote>• /id - ɢᴇᴛ ɪᴅ ᴏꜰ ᴀ ꜱᴘᴇᴄɪꜰɪᴇᴅ ᴜꜱᴇʀ.
...
• /sticker_id - ᴛᴇʟᴇɢʀᴀᴍ sᴛɪᴄᴋᴇʀ ɪᴅ</blockquote>
"""

    GROUP_TXT = """
👇 ᴄᴏᴍᴍᴀɴᴅꜱ ʟɪꜱᴛ ꜰᴏʀ ɢʀᴏᴜᴘ 👇
    
<blockquote>• /connect  - ᴄᴏɴɴᴇᴄᴛ ᴀ ᴘᴀʀᴛɪᴄᴜʟᴀʀ ᴄʜᴀᴛ ᴛᴏ ʏᴏᴜʀ ᴘᴍ.
...
• /details - ᴠɪᴇᴡ ɢʀᴏᴜᴘ sᴀᴠᴇᴅ ᴠᴀʟᴜᴇ</blockquote>
"""
...
• /stats - <code>sᴛᴜᴛᴜs ᴏғ ғɪʟᴇ ɪɴ ᴅʙ.</code>
...
• / deleteall - ᴅᴇʟᴇᴛᴇ ᴀʟʟ ɪɴᴅᴇxᴇs ғɪʟᴇs [Dᴀɴɢᴇʀ] 
• / grp_delete - ᴅᴇʟᴇᴛᴇ ᴀʟʟ ɢʀᴏᴜᴘ ғᴏʀ ᴅᴀᴛᴀʙᴀsᴇ [Dᴀɴɢᴇʀ]
• /set_value - sᴇᴛ ᴠᴀʟᴜᴇ Tʀᴜᴇ Fᴀʟsᴇ ɪɴ Dɪʀᴇᴄᴛ Bᴏᴛ
...
💵 ᴜᴘɪ ɪᴅ - Contact Admin At @rj_09_kanhaiya
...
Lᴜᴄɪғᴇʀ S𝟶𝟷 ✅
Lᴜᴄɪғᴇʀ S𝟶𝟷 E𝟶𝟻 ✅
Lᴜᴄɪғᴇʀ Sᴇᴀsᴏɴ 𝟷 Eᴘɪsᴏᴅᴇ 𝟻 ❌
ʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ғᴏʀᴍᴀᴛ ᴡʀᴏɴɢ❌ 

Bʟᴀᴄᴋ Wɪᴅᴏᴡ 𝟸𝟶𝟸𝟷 ✅
Bʟᴀᴄᴋ Wɪᴅᴏᴡ 𝟸𝟶𝟸𝟷 Mᴏᴠɪᴇ❌
Bʟᴀᴄᴋ Wɪᴅᴏᴡ 𝟸𝟶𝟸𝟷 Hɪɴᴅɪ Dᴜʙʙᴇᴅ ❌

ᴏɴʟʏ ɴᴀᴍᴇ ᴏʀ ʏᴇᴀʀ ɴᴏ ᴇxᴛʀᴀ ᴡᴏʀᴅ
🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ':(!,./)"""
